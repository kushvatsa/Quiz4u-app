...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("               Register Urself.....");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPasswordField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                    .addComponent(jPasswordField2, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                    .addComponent(jTextField3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String qry="insert into registration values('"+Name+"','"+date+"','"+Sex+"','"+Address+"','"+UserName+"','"+Password+"','"+Status+"')";
        try {
            if (!stmt.execute(qry)) {
...
public void userType(){
       ...
       date+="/"+jTextField2.getText();
       String Status="Activate";
       String qry="insert into users values('"+Type+"','"+Name+"','"+date+"','"+Sex+"','"+Address+"','"+UserName+"','"+Password+"','"+Status+"')";
        try {
            if (!stmt.execute(qry)) {
                JOptionPane.showMessageDialog(null, "Registered succesfully!!!");
            }else{
